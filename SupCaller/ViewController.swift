...
class ViewController: UIViewController {
    ...
    private func checkNumberInArr(num: String) -> Bool {
        ...
        for client in clients where client.inputNumber == num {
            inArray = true
            break
        }
        return inArray
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: ClientTVCell.identifier, for: indexPath) as? ClientTVCell else { return UITableViewCell() }
